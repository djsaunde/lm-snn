...
for name in population_names:
    ...
    # monitor state activations of excitatory and inhibitory neurons
    state_monitors[name + 'e'] = b.StateMonitor(neuron_groups[name + 'e'], 'v', record=True)
    state_monitors[name + 'i'] = b.StateMonitor(neuron_groups[name + 'i'], 'v', record=True)

...
model_name = 'csnn_two_level_inhibition_retrain'
...
if __name__ == '__main__':
	...
	parser.add_argument('--proportion_high', type=float, default=0.5, help='What proportion of the training \
																to set the inhibition at the maximum level.')
	...
	if test_mode:
		...
		num_examples = int(num_train * proportion_high)
	...
	ending = '_'.join([ str(conv_size), str(conv_stride), str(conv_features), str(n_e), \
									...
									str(proportion_high), str(start_inhib), str(max_inhib) ])

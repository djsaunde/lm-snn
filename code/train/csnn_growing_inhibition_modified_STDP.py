...
model_name = 'csnn_growing_inhibition_modified_STDP'
...
if __name__ == '__main__':
	...
	tc_countpre_ee, tc_countpost_ee = 20 * b.ms, 20 * b.ms
	...
	eqs_stdp_ee = '''
				...
				dcpre/dt = -cpre / tc_countpre_ee : 1.0
				dcountpost/dt = -countpost / tc_countpost_ee : 1.0
				'''
	...
	eqs_stdp_pre_ee = 'w -= nu_ee_pre * post * cpre; pre = 1.; cpre += 1.'
	eqs_stdp_post_ee = 'w += nu_ee_post * pre * countpost; post = 1.; countpost += 1.'

	# eqs_stdp_pre_ee = 'pre = 1.; w -= nu_ee_pre * post * countpre; countpre += 1.'
	# eqs_stdp_post_ee = 'post = 1.; w += nu_ee_post * pre * countpost; countpost += 1.'

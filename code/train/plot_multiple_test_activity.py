...
spike_activity_dir = os.path.join(top_level_path, 'spike_activity', model_name + '_multiple_test')
...
def run_activity_plotting():
	...
	ending = '_'.join([ending, str(inhibition_level), str(test_time), str(test_rest), str(num_tests)])

...
if __name__ == '__main__':
    ...
    for n in xrange(n_e):
        ...
        for y in xrange(conv_size):
            for x in xrange(conv_size):
                location = ((n % n_e_sqrt) * conv_stride + (n // n_e_sqrt) * n_input_sqrt * conv_stride) + (x * n_input_sqrt) + y
                convolution_locations[n].append(location)
    ...
    if test_mode:
        voting_schemes = ['all', 'all_active', 'most_spiked_patch', 'most_spiked_location',
                          'confidence_weighting', 'activity_neighborhood',
                          'most_spiked_neighborhood', 'distance']
    else:
        voting_schemes = ['all', 'all_active', 'most_spiked_patch', 'most_spiked_location',
                          'confidence_weighting', 'activity_neighborhood',
                          'most_spiked_neighborhood']

...
model_name = 'csnn_growing_inhibition_seizure_safe'
...
def run_train():
	...
	while j < num_examples:
		...
		old_weights = np.array(input_connections['XeAe'].W.alldata, copy=True)
		...
		if np.sum(current_spike_count) > conv_features * 25:
			input_connections['XeAe'].W.alldata = old_weights

...
echo "csnn_growing_inhibition_euclidean_test_job.sh"

python csnn_growing_inhibition.py --mode=relabel --num_train=$num_train --num_relabel=$num_train --conv_size=$conv_size --conv_stride=$conv_stride --noise_const=$noise_const \
